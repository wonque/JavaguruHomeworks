...
public class WinChecks {
    ...
    public static boolean performAll(Board gameField, String symbol) {
        return horizontalCheck(gameField, symbol) || verticalCheck(gameField, symbol)
                || diagonalCheck(gameField, symbol);
    }

    private static boolean horizontalCheck(Board gameField, String symbol) {
    ...
    private static boolean verticalCheck(Board gameField, String symbol) {
        String[] pattern = {symbol, symbol, symbol};
    ...
    private static boolean diagonalCheck(Board gameField, String symbol) {
        String[] pattern = {symbol, symbol, symbol};
